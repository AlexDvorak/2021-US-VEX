...
motor_group LeftDriveMotors =
    motor_group(LeftDriveMotorsMotorA, LeftDriveMotorsMotorB);
motor RightDriveMotorsMotorA = motor(PORT11, ratio18_1, false);
motor RightDriveMotorsMotorB = motor(PORT13, ratio18_1, false);
motor_group RightDriveMotors =
    motor_group(RightDriveMotorsMotorA, RightDriveMotorsMotorB);
